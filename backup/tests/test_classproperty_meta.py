...
from backup.pytips.types_demo.classproperty_demo import ClassProperty, ClassPropertyMeta
from backup.pytips.types_demo.classproperty_demo import clsproperty
