...
@app.command()
def add(project_name: str = typer.Option(..., "--project-name", "-pn", prompt=True,
                                         metavar="Name by which you like to call this project 🥺")):
    """
...
@app.command()
def open(project_name: str = typer.Argument(..., autocompletion=AutoComplete.list_projects,
                                            metavar="Project Name which you used while adding 🥺")):
    """
...
@app.command()
def remove(project_name: str = typer.Option(..., "--project-name", "-pn", autocompletion=AutoComplete.list_projects,
